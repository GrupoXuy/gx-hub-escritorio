...
export function Avatar3D({ member, size = 48, own = false, showRing = false, isMoving = false }: { member: Avatar3DMember; size?: number; own?: boolean; showRing?: boolean; isMoving?: boolean }) {
  ...
  const back = direction === "back" || direction === "ur" || direction === "ul";
...
export function Avatar3DStyles() {
  return <style jsx global>{`
    ...
    .gx3d-ground{position:absolute;left:14%;right:14%;bottom:4%;height:9%;border-radius:50%;background:#0009;filter:blur(2px);transform:scaleX(.85);transition:opacity .25s,transform .25s}.gx-avatar3d-back .gx3d-ground{opacity:.7;transform:scaleX(.9)}
    ...
    .gx3d-head{position:absolute;left:30%;right:30%;top:9%;height:42%;border-radius:46% 46% 43% 43%;transform:perspective(420px) rotateX(var(--gx-look-y)) rotateY(var(--gx-look-x));background:linear-gradient(105deg,var(--gx-skin-dark),var(--gx-skin) 43%,var(--gx-skin-light));box-shadow:inset -4px -3px 6px #0004,2px 2px 5px #0008;z-index:5;transform-origin:50% 80%}
    ...
    .gx-avatar3d-back .gx3d-eye,.gx-avatar3d-back .gx3d-mouth,.gx-avatar3d-back .gx3d-facial,.gx-avatar3d-back .gx3d-glasses,.gx-avatar3d-back .gx3d-earring,.gx-avatar3d-ul .gx3d-eye,.gx-avatar3d-ul .gx3d-mouth,.gx-avatar3d-ul .gx3d-facial,.gx-avatar3d-ul .gx3d-glasses,.gx-avatar3d-ul .gx3d-earring,.gx-avatar3d-ur .gx3d-eye,.gx-avatar3d-ur .gx3d-mouth,.gx-avatar3d-ur .gx3d-facial,.gx-avatar3d-ur .gx3d-glasses,.gx-avatar3d-ur .gx3d-earring{display:none}
