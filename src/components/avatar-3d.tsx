...
export function Avatar3D({ member, size = 48 }: { member: Avatar3DMember; size?: number }) {
  ...
  const style = {
    ...
    "--gx3d-accent": accent,
    "--gx3d-outfit": accent,
    "--gx3d-outfit-dark": shade(accent, 0.34),
    "--gx3d-outfit-light": tint(accent, 0.22),
    "--gx3d-tilt": `${tilt}deg`,
...
export function Avatar3DStyles() {
  return (
    <style jsx global>{`
      ...
      .gx-avatar3d-torso.outfit-suit{background:linear-gradient(100deg,var(--gx3d-outfit-dark),var(--gx3d-outfit) 48%,var(--gx3d-outfit-dark));border-bottom:2px solid var(--gx3d-outfit-light)}
      .gx-avatar3d-torso.outfit-blazer{background:linear-gradient(100deg,var(--gx3d-outfit-dark),var(--gx3d-outfit-light) 48%,var(--gx3d-outfit-dark));border-bottom:2px solid var(--gx3d-outfit-light)}
      .gx-avatar3d-torso.outfit-shirt{background:linear-gradient(100deg,var(--gx3d-outfit-light),var(--gx3d-outfit) 50%,var(--gx3d-outfit-dark));box-shadow:inset 3px 0 5px #fff8,0 3px 5px #0005}
      .gx-avatar3d-torso.outfit-hoodie{background:linear-gradient(100deg,var(--gx3d-outfit-dark),var(--gx3d-outfit) 50%,var(--gx3d-outfit-dark));border-radius:20% 20% 15% 15%;box-shadow:inset 3px 0 5px #fff2,0 4px 6px #0008}
      .gx-avatar3d-torso.outfit-tee{background:linear-gradient(100deg,var(--gx3d-outfit),var(--gx3d-outfit-dark));border-radius:18% 18% 12% 12%;border-bottom:3px solid var(--gx3d-outfit-dark)}
      .gx-avatar3d-lapel{position:absolute;top:8%;width:27%;height:55%;border-left:1px solid #f0d7a066}
      .gx-avatar3d-lapel.left{left:26%;transform:skewY(25deg)} .gx-avatar3d-lapel.right{right:26%;transform:skewY(-25deg)}
      .outfit-shirt .gx-avatar3d-lapel{border-color:#fff8;opacity:.55}.outfit-hoodie .gx-avatar3d-lapel,.outfit-tee .gx-avatar3d-lapel{display:none}
      .gx-avatar3d-tie{position:absolute;top:10%;left:46%;width:8%;height:45%;background:linear-gradient(var(--gx3d-outfit-light),var(--gx3d-outfit-dark));clip-path:polygon(35% 0,65% 0,100% 20%,62% 100%,38% 100%,0 20%)}
      .outfit-hoodie .gx-avatar3d-tie,.outfit-tee .gx-avatar3d-tie{display:none}.outfit-blazer .gx-avatar3d-tie{opacity:.35}.outfit-shirt .gx-avatar3d-tie{background:linear-gradient(var(--gx3d-outfit),var(--gx3d-outfit-dark));}
      .gx-avatar3d-pocket{position:absolute;right:14%;top:33%;width:18%;height:12%;border:1px solid var(--gx3d-outfit-light);border-radius:2px;opacity:.9}.outfit-hoodie .gx-avatar3d-pocket{left:35%;right:auto;top:55%;width:30%;height:18%;border-radius:0 0 8px 8px}.outfit-tee .gx-avatar3d-pocket{display:none}
      ...
      .gx-avatar3d-ur .gx-avatar3d-eye,.gx-avatar3d-ur .gx-avatar3d-mouth,.gx-avatar3d-ur .gx-avatar3d-beard,.gx-avatar3d-ur .gx-avatar3d-glasses,.gx-avatar3d-ur .gx-avatar3d-earring,.gx-avatar3d-ur .gx-avatar3d-headset{display:none}
      .gx-avatar3d-ul .gx-avatar3d-eye,.gx-avatar3d-ul .gx-avatar3d-mouth,.gx-avatar3d-ul .gx-avatar3d-beard,.gx-avatar3d-ul .gx-avatar3d-glasses,.gx-avatar3d-ul .gx-avatar3d-earring,.gx-avatar3d-ul .gx-avatar3d-headset{display:none}
