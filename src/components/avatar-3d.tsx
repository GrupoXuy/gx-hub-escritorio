...
export function Avatar3D({ member, size = 48 }: { member: Avatar3DMember; size?: number }) {
  ...
  return (
    <span
      className={`gx-avatar3d gx-avatar3d-${action} gx-avatar3d-${direction}`}
      style={style}
...
export function Avatar3DStyles() {
  return <style jsx global>{`
    ...
    .gx3d-aura{position:absolute;inset:4%;border-radius:50%;background:radial-gradient(circle,#d6b46a38 0,#d6b46a12 38%,transparent 72%);opacity:.8}
    ...
    .gx3d-jacket{position:absolute;left:21%;right:21%;bottom:31%;height:38%;border-radius:25% 25% 13% 13%;background:linear-gradient(105deg,var(--gx-outfit-dark),var(--gx-outfit) 46%,var(--gx-outfit-dark));box-shadow:inset 4px 0 5px #fff2,0 4px 7px #0008;z-index:2;overflow:hidden;transition:background .2s,border-radius .2s}
    ...
    .gx3d-zip{position:absolute;top:4%;bottom:5%;left:49.2%;width:1px;background:#d7d9dc99;box-shadow:1px 0 #0005}
    ...
    .gx3d-neck{position:absolute;left:42%;bottom:62%;width:16%;height:10%;border-radius:35%;background:linear-gradient(90deg,var(--gx-skin-dark),var(--gx-skin),var(--gx-skin-light));z-index:2}
    .gx3d-head{position:absolute;left:27%;right:27%;top:10%;height:45%;border-radius:46% 46% 43% 43%;background:linear-gradient(105deg,var(--gx-skin-dark),var(--gx-skin) 43%,var(--gx-skin-light));box-shadow:inset -4px -3px 6px #0004,2px 2px 5px #0008;z-index:5;transform-origin:50% 80%}
    ...
    .gx3d-eye{position:absolute;top:48%;width:11%;height:8%;border-radius:50%;background:#fff;z-index:2}.gx3d-eye:after{content:"";position:absolute;inset:25%;border-radius:50%;background:#17191b}.gx3d-eye.left{left:24%}.gx3d-eye.right{right:24%}
    ...
    .gx3d-arms{position:absolute;inset:0;z-index:1}.gx3d-arms i{position:absolute;top:34%;width:12%;height:31%;border-radius:48%;background:linear-gradient(90deg,var(--gx-skin-dark),var(--gx-skin),var(--gx-skin-light));transform-origin:50% 8%;box-shadow:inset 1px 0 2px #fff2}.gx3d-arms .left{left:10%;transform:rotate(9deg)}.gx3d-arms .right{right:10%;transform:rotate(-9deg)}
